...
export default function Notifications({
    ...
    const handleSearch = (e) => {
        ...
        setLoading(true);
        router.get(
            route("logistic.notifications.index"),
            {
                search: searchTerm,
                type: typeFilter,
                status: statusFilter,
    ...
    const handleMarkAsRead = (notificationId) => {
        setLoading(true);
        router.post(
            route("logistic.notifications.markRead", notificationId),
            {},
            {
                onFinish: () => setLoading(false),
            },
    ...
    const handleMarkAllAsRead = () => {
        setLoading(true);
        router.post(
            route("logistic.notifications.markAllRead"),
            {},
            {
                onFinish: () => setLoading(false),
            },
    ...
    const handleDelete = (notificationId) => {
        if (!confirm("Are you sure you want to delete this notification?"))
            return;
        setLoading(true);
        router.delete(route("logistic.notifications.delete", notificationId), {
            onFinish: () => setLoading(false),
        });
    };
        ...
        <div className="min-h-screen bg-gray-50 flex">
            ...
            <div className="flex-1 flex flex-col">
                ...
                <main className="flex-1 p-8 overflow-y-auto">
                    <Head title="Notifications - Logistic" />
